    ...
    <div className="min-h-screen bg-gray-50/50 flex flex-col items-center font-sans p-4">
      <div className="w-full max-w-2xl py-16">
        ...
        <div className="bg-white rounded-2xl p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 space-y-4 text-sm text-gray-600 leading-relaxed">
          <p>
            This is a placeholder terms of service for Mimamori. Full terms
            covering usage rights, limitations, liability, and account policies
            will be published before the application is made publicly available.
          </p>
          <p>
            If you have questions about the terms of use, please contact our
            team.
          </p>
        </div>
      </div>
