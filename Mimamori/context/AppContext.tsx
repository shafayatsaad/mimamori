...
export interface DailyLog {
  ...
  entities?: any[];
  recommendation?: { recommendation: string; severity: 'good' | 'info' | 'warning' };
}
...
interface AppContextType {
  ...
  logs: DailyLog[];
  addLog: (text: string, probes: string[], entities?: any[], probeAnswers?: { question: string; title: string; answer: string }[]) => string;
...
export function AppProvider({ children }: { children: ReactNode }) {
  ...
  const addLog = (text: string, probes: string[], entities?: any[], probeAnswers?: { question: string; title: string; answer: string }[]): string => {
  ...
  return (
    <AppContext.Provider value={{
      ...
      logs, addLog, updateLog, removeLog,
