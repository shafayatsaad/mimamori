...
*   **安全な認証**: 多要素認証 (MFA) をサポートする **AWS Amplify** を採用。
...
graph TD
    ...
    NextJS -->|メタデータ| SQLite[Prisma + SQLite]
...
| **データベース** | DynamoDB + Prisma (SQLite) | スケーラブルな状態管理とリレーショナルメタデータ |
| **認証** | AWS Amplify Auth | 安全なユーザーID管理 |
